...
- **Axes d'amélioration** :
  ...
  - **Verrouillage de l'écran (Wake Lock)** : Pendant le suivi d'une séance ou d'un repos, l'écran du smartphone a tendance à se mettre en veille, coupant le rythme. L'utilisation de l'API _Screen Wake Lock_ (si supportée) résoudrait ce problème ergonomique majeur.
